    ...
    public ManageMembers() {
        ...
        ActionListener select_listener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // TODO: check if valid user id ie. valid input, database returns valid user.
                delete_account.setVisible(true);
                int user_id = Integer.parseInt(user_id_field.getText());
                selected_user = new Database().fetchUser(user_id);
        ...
        ActionListener delete_listener = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TODO: check if valid user id ie. valid input, database returns valid user and user cannot delete self.
